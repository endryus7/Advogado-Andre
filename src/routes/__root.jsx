...
export const Route = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Dr. André Albani Lara — Advocacia Criminal" },
      {
        name: "description",
        content:
          "Advogado especializado em Direito Penal e Processual Penal em Porto Alegre e Região.",
      },
      { name: "author", content: "Dr. André Albani Lara" },
